  ...
  return (
    <View style={styles.container}>
      <ScrollView>
        ...
        <View style={styles.carouselItem}>
          <Text style={styles.title}>BOXE professionelle</Text>
          <Text style={styles.time}>DU LUNDI AU VENDREDI DE 19H30 À 21H00</Text>
          <Text style={styles.price}>Tarif: selon le groupe  en vigeur </Text>
        </View>
        <View style={styles.carouselItem}>
          <Text style={styles.title}>Aeroboxe</Text>
          <Text style={styles.time}>DU LUNDI AU VENDREDI DE 19H30 À 21H00</Text>
          <Text style={styles.price}>Tarif: 150€ une seances par  semaine </Text>
        </View>
